...
console.log(echoMelhorado(27)); // aqui posso colocar o tipo que preciso
// generics disponiveis na API - array
const avaliacaoes = [10, 9.3, 7.7];
...
const fila = new Fila("jo", "lua", "sol", "agua");
fila.imprimir();
fila.entrar("Rafa");
fila.imprimir();
...
const fila2 = new Fila2("jo", "lua", "sol", "agua");
fila2.imprimir();
fila2.entrar("Rafa");
fila2.imprimir();
